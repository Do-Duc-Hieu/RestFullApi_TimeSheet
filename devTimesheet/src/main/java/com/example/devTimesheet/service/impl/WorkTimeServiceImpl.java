...
public class WorkTimeServiceImpl implements WorkTimeService {
    ...
    public WorkTimeRespon getWorkTime(Integer id){
        return workTimeMapper.toWorkTimeRespon(workTimeRepository.findById(id)
    ...
    public List<WorkTimeRespon> findAllWorkTime(){
        ...
        workTimes.forEach(
                workTime -> workTimeRespons.add(workTimeMapper.toWorkTimeRespon(workTime))
    ...
    public WorkTimeRespon updateWorkTime(Integer idWorkTime, WorkTimeRequest request) {
        WorkTime workTime = workTimeRepository.findById(idWorkTime)
