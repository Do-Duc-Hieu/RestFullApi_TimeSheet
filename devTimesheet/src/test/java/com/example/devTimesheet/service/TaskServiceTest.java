...
public class TaskServiceTest {
    ...
    @BeforeEach
    void initData() {
        taskRequest = TaskRequest.builder().nameTask("dev10").build();
        taskRespon = TaskRespon.builder().id(10).nameTask("dev10").build();
        task1 = Task.builder().nameTask("dev10").build();
        task = Task.builder().id(10).nameTask("dev10").build();
    }
